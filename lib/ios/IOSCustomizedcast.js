...
let IOSCustomizedcast = function (_IOSNotification) {
    _inherits(IOSCustomizedcast, _IOSNotification);

    function IOSCustomizedcast(appKey, appMasterSecret) {
        _classCallCheck(this, IOSCustomizedcast);

        var _this = _possibleConstructorReturn(this, (IOSCustomizedcast.__proto__ || Object.getPrototypeOf(IOSCustomizedcast)).call(this));
    ...
    _createClass(IOSCustomizedcast, [{
        key: 'setAlias',
